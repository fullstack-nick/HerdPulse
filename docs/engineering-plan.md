# HerdPulse — Engineering Plan

> This detailed implementation and decision record is retained for deeper review. Start with the concise [project README](../README.md).
